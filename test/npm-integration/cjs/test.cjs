/**
 * CJS Require Integration Test
 *
 * Verifies that the built package can be required correctly in CommonJS environment.
 */
...
const node = require('type-git/node');
...
const bun = require('type-git/bun');
...
const deno = require('type-git/deno');
